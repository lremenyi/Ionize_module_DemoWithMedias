...
class Author extends Module_Admin
{
	...
	*/
	...
	/**
	 * Outputs the authors list to the options panel 
	 */
	public function get_list_options()
	{
		...
		$this->output('admin/author_list_options');
	}
	...
	public function save()
	{
		...
		{
			$id_module_demo_author = $this->author_model->save($this->input->post());
	...
	public function add_link()
	{
		$parent = $this->input->post('parent');
		$id_parent = $this->input->post('id_parent');
		$id_module_demo_author = $this->input->post('id_module_demo_author');

		if ($this->author_model->link_author_to_parent($parent, $id_parent, $id_module_demo_author))
		{
			// Set the callbacks
			$this->update_dom_linked_authors($parent, $id_parent, $id_module_demo_author);
	...
	public function unlink()
	{
		...
		$this->author_model->unlink_author_from_parent($parent, $id_parent, $id_module_demo_author);
