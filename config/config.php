...
(
	'module' => "Demo",
    'name' => "Demo Module with media edit",
	'description' => "Author Demo module. Manage articles's authors and its medias.<br/>This module is one Demo module, based on the tutorial available on: http://doc.ionizecms.com/en/tutorials",
	'author' => "Partikule, andreaspollak, ReL@",
	'version' => "1.2",
